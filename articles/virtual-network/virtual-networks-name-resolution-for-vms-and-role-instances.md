...
> [!IMPORTANT]
> While using Conditional Forwarders on your DNS Server VM in Azure for a Private DNS Zone, make sure to use Azure DNS IP (168.63.129.16) as Primary **and** Secondary Name Servers for resiliency.
